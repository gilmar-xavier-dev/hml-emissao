...
type Chargeback struct {
	...
	// Código de autorização retornado na transação original. *Em transações internacionais esse valor não será o mesmo da transação original.*
	...
	Card *Card `json:"card"`
	// Indica se o estorno é total ou parcial.
	ChargebackMode string `json:"chargeback_mode"`

	OriginalAmount *Amount `json:"original_amount"`

	ChargebackAmount *Amount `json:"chargeback_amount"`

	EntryMode *EntryMode `json:"entry_mode"`

	ChargebackReason *CancellationReason `json:"chargeback_reason"`
