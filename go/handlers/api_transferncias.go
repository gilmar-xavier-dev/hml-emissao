...
func CreateTransfer(w http.ResponseWriter, r *http.Request) {
	fmt.Fprintf(w, "CreateTransfer: [%s]", r.Body)
	w.Header().Set("Content-Type", "application/json; charset=UTF-8")
	w.WriteHeader(http.StatusOK)
}

func CreateTransferCancellation(w http.ResponseWriter, r *http.Request) {
	fmt.Fprintf(w, "CreateTransferCacelallation: [%s]", r.Body)
	w.Header().Set("Content-Type", "application/json; charset=UTF-8")
	w.WriteHeader(http.StatusOK)
}
