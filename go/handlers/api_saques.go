...
func CreateWithdrawal(w http.ResponseWriter, r *http.Request) {
	fmt.Fprintf(w, "CreateWithdrawal: [%s]", r.Body)
	w.Header().Set("Content-Type", "application/json; charset=UTF-8")
	w.WriteHeader(http.StatusOK)
}

func CreateWithdrawalCancellation(w http.ResponseWriter, r *http.Request) {
	fmt.Fprintf(w, "CreateWithdrawalCancellation: [%s]", r.Body)
	w.Header().Set("Content-Type", "application/json; charset=UTF-8")
	w.WriteHeader(http.StatusOK)
}
